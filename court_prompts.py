...
SAFETY_PROMPT = f"""
You are an expert AI safety classifier specializing in Hate Speech Detection. Your task is to analyze the provided tweet (text and image) and determine if it expresses hate speech against a protected group.
...
- Your rebuttal should avoid generic statements and should be specific to the Prosecutor’s cues.
...
- If one or more cues credibly indicate hateful intent after considering Defense, assign hate label (1-5).
